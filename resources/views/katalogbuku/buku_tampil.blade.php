...
<body>
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <form action="/updatedata/{{ $data_buku->id }}" method="POST" enctype="multipart/form-data">
                @csrf
                <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                        <tr>
                            <td>
                                <input type="text" class="form-control" name="judul" value="{{ $data_buku->judul }}" required>
                            </td>
                            <td>
                            ...
                            <td>
                                <input type="text" class="form-control" name="tahun_terbit" value="{{ $data_buku->tahun_terbit }}" required>
                            </td>
                            <td>
